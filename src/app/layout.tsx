...
import { Scan, Globe, Activity } from "lucide-react";
import "./globals.css";
      ...
      <body className={`${inter.className} bg-[#0a0a0c] text-cyan-50 antialiased overflow-hidden flex flex-col h-screen`}>
        ...
        <nav className="h-14 bg-[#0d0d12] border-b border-cyan-900/40 flex items-center justify-between px-6 shrink-0 relative z-50 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
          <div className="flex items-center gap-6">
            ...
            <Link href="/" className="text-xs font-mono font-bold tracking-widest uppercase text-cyan-600 hover:text-cyan-300 transition-colors flex items-center gap-2">
              <Activity className="w-3.5 h-3.5" />
              OSINT Tools
            </Link>
            
            <Link href="/media" className="text-xs font-mono font-bold tracking-widest uppercase text-fuchsia-600 hover:text-fuchsia-300 transition-colors flex items-center gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono text-cyan-500/70 uppercase tracking-widest">SECURE LINK</span>
          </div>
        </nav>
